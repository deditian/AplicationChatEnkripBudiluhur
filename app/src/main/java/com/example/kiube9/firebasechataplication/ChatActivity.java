...
public class ChatActivity extends AppCompatActivity {
    ...
    public void onStart() {
        ...
        //Log.d("LOGGED", "IN onStart ");
            ...
            mFirebaseAdapter = new FirebaseRecyclerAdapter<Show_Chat_Activity_Data_Items, Show_Chat_ViewHolder>(Show_Chat_Activity_Data_Items.class,
                ...
                public void populateViewHolder(final Show_Chat_ViewHolder viewHolder, Show_Chat_Activity_Data_Items model, final int position) {
                    ...
                    if (!model.getName().equals("Null")) {
                        ...
                        String satu[] = model.getEmail().split("@");
                        String dua[] = LoggedIn_User_Email.split("@");
                    //    if(model.getEmail().equals(SignIn.LoggedIn_User_Email))
                        if(satu[1].equals("budiluhur.ac.id") == dua[1].equals("budiluhur.ac.id"))
                        {
